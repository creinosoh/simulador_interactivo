...
// Función para calcular el nombre del mes 
// en función del número de mes ingresado

function calculaNombreMes(mes) {
...
// Función que permite ingresar la fecha de nacimiento del usuario recibiendo
// como parametro una instancia del objeto fechaNacimiento
// y valida que los números ingresados
// sean válidos

function ingresaFechaValida(fecha) {
    let diaValido = false;
    let mesValido = false;
    let añoValido = false;

    console.log("valor diaValido es: " + diaValido);
    console.log("valor del objeto fecha " + fecha.dia);
    ...
    do {
        ...
        fecha.dia = parseInt(prompt("Ingresa el dia que naciste:"));
        if (1 <= fecha.dia && fecha.dia <= 31) {
            diaValido = true;
        } else {
    ...
    do {
        ...
        fecha.mes = parseInt(prompt("Ingresa el mes en que naciste:"));
    ...
    do {
        ...
        fecha.año = parseInt(prompt("Ingresa el año en que naciste:"));
        if (1900 <= fecha.año && fecha.año <= 2022) {
            añoValido = true;
        } else {
...
function calculaNumeroNacimiento(fecha) {
